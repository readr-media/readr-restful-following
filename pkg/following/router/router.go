...
func bindFollow(c *gin.Context) (result interface{}, err error) {
	...
	case "user":
		...
		var params = &model.GetFollowingArgs{}
	...
	case "resource":
		...
		var params = &model.GetFollowedArgs{}
...
func (r *followingHandler) Get(c *gin.Context) {
	...
	case *model.GetFollowingArgs:
		result, err = model.FollowingAPI.Get(input)
